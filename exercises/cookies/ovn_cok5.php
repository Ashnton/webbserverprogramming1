    ...
    <form action="" method="post">
        ...
        if ($_SESSION["permission"]) {
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                if (!empty($_SESSION['q' . $_SESSION["curr_q"]])) {
                    $_SESSION["curr_q"]++;
                } else if ($curr_q > 3) {
                    $_SESSION['curr_q']++;
                }
                ...
                if ($curr_q === 5) {
                    $namn = $_SESSION["name"];
                    $correct_answers = $_SESSION["correct-answers"];
                    ...
                    mail($_SESSION["email"], "Ditt resultat", $content, $mejlhuvud);
                }
        ...
        ?>
                        ...
                        <fieldset>
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    foreach ($svarsalternativ as $alternativ) {
                                        if ($alternativ == $_SESSION["q2"] && $alternativ == "Ja") {
                                    ?>
                                            <span class="green">
                            ...
                            <div>
                                ...
                                <div>
                                    <?php
                                    foreach ($svarsalternativ as $alternativ) {
                                        if ($alternativ == $_SESSION["q3"] && $alternativ == "Kanske") {
                                    ?>
                                            <span class="green">
            ...
            if (password_verify($_SESSION["password"], '$2y$10$FUnyKcPyEKHABYTBdJl7QeKNtS8JgqbjM4wHT38kyT1WYNy90KbmS')) {
