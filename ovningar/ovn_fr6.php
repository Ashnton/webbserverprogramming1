...
<body>
    ...
    <?php 
        if (!empty($_POST["förnamn"])) {
            ...
            if (count($_POST["maträtter"]) > 1) {
                $matpreposition = "maträtterna";
            } else {
                $matpreposition = "maträtten";
            }

            $min_sträng = "Hjärtligt välkommen " . $_POST['förnamn'] . " " . $_POST['efternamn'] . " i " . $_POST["klass"] . ". Du gillar " . $matpreposition . " " . $matsträng . ". Din favoritkurs är " . $_POST["kurs"];
            echo $min_sträng;
            mail("filipfg@varmdogymnasium.se", "BFS Formripper Service", $min_sträng);
        }
    ?>
</body>
</html>